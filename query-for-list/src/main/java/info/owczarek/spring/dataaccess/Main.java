...
//        ApplicationContext context = new AnnotationConfigApplicationContext(AppConfiguration.class);
        ...
        List<Map<String, Object>> productsWithPriceGreaterThen = productsRepository.getProductsWithPriceGreaterThen(70.0);
        for (Map<String, Object> productsMap : productsWithPriceGreaterThen) {
